...
const Perks = ({ perks, setPerks }) => {
    ...
    return (
        <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4">
            <label htmlFor="wifi" className="flex items-center cursor-pointer gap-2 px-4 py-3 rounded-xl border border-gray-300">
            ...
            <label htmlFor="parking" className="flex items-center cursor-pointer gap-2 px-4 py-3 rounded-xl border border-gray-300">
            ...
            <label htmlFor="tv" className="flex items-center cursor-pointer gap-2 px-4 py-3 rounded-xl border border-gray-300">
            ...
            <label htmlFor="radio" className="flex items-center cursor-pointer gap-2 px-4 py-3 rounded-xl border border-gray-300">
            ...
            <label htmlFor="pets" className="flex items-center cursor-pointer gap-2 px-4 py-3 rounded-xl border border-gray-300">
            ...
            <label htmlFor="entrance" className="flex items-center cursor-pointer gap-2 px-4 py-3 rounded-xl border border-gray-300">
                <input type="checkbox" id="entrance" value={"entrance"}
                onChange={(e) => handleclick(e.target)
                    }
                />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
